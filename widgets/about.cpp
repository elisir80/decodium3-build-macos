  ...
  ui(new Ui::CAboutDlg)
{
  ...
  ui->labelTxt->setText(
    ...
    "<p><b>Fork " FORK_RELEASE_VERSION " highlights:</b> FT2 anti-ghost filtering, "
    "updated FT2/FT4/FT8 Costas sync handling, web app Monitoring ON/OFF, FT2 ASYNC dB display, "
    "CQ/73 activity filters, full UI/web language alignment, and hardened secure settings/download handling.</p>"
    "<hr>"
