# Decodium v3.0 SE "Raptor" - Fork 9H1SR v1.3.2 (Italiano)

Per la versione bilingue completa (English + Italiano), vedere [README.md](README.md).

## Sintesi italiana

Questa release fork (`v1.3.2`) e' basata su Decodium v3.0 SE Raptor upstream e introduce hardening operativo specifico per macOS:
